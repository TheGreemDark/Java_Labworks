...
public class Example10 {
     public static void main(String[] args) {
        ...
        List<Integer> integersAfter = filterLessThanThreshold(integers, threshold);
    ...
    public static List<Integer> filterLessThanThreshold(List<Integer> list, int threshold) {
        ...
        return list.stream()
                .filter(number -> number < threshold) // Фильтрация чисел, которые меньше threshold
